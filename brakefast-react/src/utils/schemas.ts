...
export const ArticleSchema = z.object({
  ...
  content_extracted: z.boolean().optional(),
  content_quality: z.enum(['high', 'medium', 'low']).optional(),
  summary_quality_score: z.number().optional(),
  image_quality_score: z.number().optional(),
